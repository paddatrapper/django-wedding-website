...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'wedding.processors.bride_and_groom_processor',
            ],
        },
    },
]
...
DEFAULT_WEDDING_FROM_EMAIL = 'Kyle and Jessica <us@kyleandjess.co.za>'
# the default reply-to of your emails
DEFAULT_WEDDING_REPLY_EMAIL = 'rsvp@kyleandjess.co.za'

# when sending test emails it will use this address
DEFAULT_WEDDING_TEST_EMAIL = DEFAULT_WEDDING_FROM_EMAIL

# This is used in a few places where the names of the couple are used
BRIDE_AND_GROOM = 'Kyle and Jessica'

# This is used in links in save the date / invitations
WEDDING_WEBSITE_URL = 'https://kyleandjess.co.za'
